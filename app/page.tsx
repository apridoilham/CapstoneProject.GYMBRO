...
export const metadata: Metadata = {
  ...
  description: 'Elevate your physique with GYM BRO. Hyper-personalized AI training, nutrition strategies, and intelligent body analysis. Your journey to peak performance starts here.',
};
...
export default function HomePage() {
  return (
    <div className="bg-black text-white selection:bg-primary/40 selection:text-white overflow-x-hidden">
      ...
      {/* Section "Why Choose GYM BRO?" atau "Beyond the Hype" yang menggunakan ValuePropCard/StatCard telah dihapus. */}
      ...
      <section className="py-20 md:py-28 bg-zinc-950 text-center">
        <div className="container mx-auto px-4 md:px-8 max-w-2xl">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6 tracking-tight animate-fade-in" style={{animationDelay: '0.2s'}}>
              Ready to Evolve, <BroText>BRO</BroText>?
            </h2>
            <p className="text-lg md:text-xl text-gray-400 mb-10 animate-fade-in" style={{animationDelay: '0.4s'}}>
              Your peak physique is within reach. Join the GYM BRO movement and begin your intelligent fitness transformation today.
            </p>
            <div className="animate-fade-in" style={{animationDelay: '0.6s'}}>
              ...
              >
                <Link href="/register">
                  Start Your Journey Now <ArrowRight size={20} className="ml-2 group-hover:translate-x-1 transition-transform" />
                </Link>
              </Button>
            </div>
        </div>
